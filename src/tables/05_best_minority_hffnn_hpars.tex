\begin{table}
\caption[Best HFFNN Minority Hyperparameter Combinations]{Top 10 performing Minority HFFNN hyperparameter combinations, ordered by the lower bound of the 90 percent confidence interval for $F_1$-score.}
\label{tab:appendix_best_minority_hffnn_hpars}
