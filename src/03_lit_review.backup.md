...
hands: glove-based, vision-based, and (most recently) WiFi-based. These three
methods will be explored in subsections \ref{glove-based-systems},
...
coordinates to the host computer.
...
@hernandez-rebollarAcceleGloveWholehandInput2002 used six accelerometers
mounted in rings on the back of the middle phalanges, on the distal phalange of
the thumb, and on the back of the wrist. The authors briefly mention developing
virtual hand software which could map accelerometer readings to hand positions,
...
machine to classify signs from the Arabic sign language.
...
successor to the original DataGlove).
...
### Before the 1980s {#sss:vision-based-1980s}
...
eyebrows towards the end of the sentence.
