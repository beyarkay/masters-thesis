...
% \include{tex/00_acknowledgements}
\chapter*{Acknowledgements}

% TODO
Acknowledgements chapter has not been written % TODO

% \include{tex/00_dedication}
\chapter*{Dedication}
...
\include{tex/02_background}

% src/03_lit_review.md
\chapter{Literature Review}\label{chap:literature-review}
\include{tex/03_lit_review}

% src/04_methodology.md
\chapter{Methodology}\label{chap:methodology}
\include{tex/04_methodology}
